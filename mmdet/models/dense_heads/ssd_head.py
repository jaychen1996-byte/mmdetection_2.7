...
class SSDHead(AnchorHead):
    ...
    def __init__(self,
        ...
        self.anchor_generator = build_anchor_generator(anchor_generator)  # 得到anchor_generator类
    ...
    def forward(self, feats):
        ...
        return cls_scores, bbox_preds  # 网络结构上的直线推理
    ...
    def loss(self,
        ...
        cls_reg_targets = self.get_targets(  # 计算每个anchor属于哪一类
            anchor_list,
            valid_flag_list,
            gt_bboxes,
            img_metas,
